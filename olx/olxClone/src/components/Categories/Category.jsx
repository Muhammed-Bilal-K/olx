        ...
        <div className='Second_Outer'>
            <div className="container">
                ...
                <div className="row" >
                    ...
                    <div className="col-sm">
                        <div className="card">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-scooter" viewBox="0 0 16 16">
                    ...
                    <div className="col-sm">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title">Properites</h5>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm">
                    ...
                    <div className="col-sm">
                        <div className="card">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-ticket-perforated-fill" viewBox="0 0 16 16">
                ...
                <div className="row">
                    ...
                    <div className="col-sm">
                        <div className="card">
                            ...
                            <div className="card-body">
                                <h5 className="card-title">BackPack</h5>
                            </div>
                        </div>
                    </div>
                    <div className="col-sm">
